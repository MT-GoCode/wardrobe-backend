...
For a city scene: with no changes to the person, no changes to clothing, no changes to lighting, no changes to scenery, sharpen realistic concrete grain and pavement texture, add metallic glint to cars, increase detail of plant foliage, improve roughness of wall texture

For a nature scene: with no changes to the person, no changes to clothing, no changes to lighting, no changes to scenery, enhance natural ground texture, sharpen dirt path detail, increase high-frequency detail in grass and foliage, enrich fine leaf edges, add subtle roughness and micro-texture to plants, improve realism of tree bark detail, increase depth and crispness of sunset haze without altering direction or color, preserve overall geometry and composition
