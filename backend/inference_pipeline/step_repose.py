...
def repose_single(bgr_image_url, setting, gender):
    prompt = f"The {gender} has pose {setting['pose']}, with exact same face, realistic skin without imperfections, realistic eyes, exact same facial identity, exact same clothing, exact same details, correct body structure"
